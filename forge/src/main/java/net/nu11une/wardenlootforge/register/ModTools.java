...
public class ModTools {
    ...
    public static final RegistryObject<Item> SCULK_PICKAXE = TOOLS.register("sculk_pickaxe", () -> new PickaxeItem(ModToolMaterials.SCULKERITE, 0, -3, new Item.Properties().tab(WardenLootTab.WARDEN_LOOT_TAB).fireResistant()));
